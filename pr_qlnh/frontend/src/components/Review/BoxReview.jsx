    ...
    return (
        <div className="space-y-4">
            {reviews.map(review => {
                ...
                return (
                    <div key={review.review_id} className="boxReview-comment border p-3 rounded-lg shadow-sm">
                        ...
                        {isOpenFeedback && (
                            <div className="ml-4 border-l-2 border-gray-300 pl-2">
                                <AdminFeedback reviewId={review.review_id} />
                                <UserFeedback reviewId={review.review_id} />
                            </div>
                        )}

                        {isOpenReply && (
                            <div className="ml-4 border-l-2 border-gray-300 pl-2 mt-2">
                                {/* TODO: Reply form / messages */}
                                <p className="text-sm text-gray-500">Form phản hồi</p>
                            </div>
                        )}
                    </div>
                );
